<template>
    <div>
        <div class="mb-3 float-right">
            <b-button variant="primary" @click="toggleEditMode()" v-if="isVocabularyEditor && !editMode"><i class="fa fa-edit"></i> Edit</b-button>
            <b-button variant="secondary" @click="toggleEditMode()" v-if="editMode">Cancel</b-button>
        </div>
