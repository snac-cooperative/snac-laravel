    ...
    <form action="/repositories/create" method="post">
      <div class="form-group">
        ...
        <input
          ...
          id="taskTitle"
          name="name"
          placeholder="e.g. Institutional Records and Archives, Getty Research Institute"
        />
      </div>
      <div class="form-group">
        <label for="title">
          ...
          <i
            ...
            data-toggle="tooltip"
            data-placement="right"
            title="Brief description of holding institution and scope of collections; may include access information"
          ></i>
        </label>
        <textarea
          type="text"
      ...
      <div>
        ...
        <b-button v-b-toggle.collapse-2 class="m-1"
          >Toggle Collapse Modifiers</b-button
        >
      ...
      <div class="form-group" id="address-question">
        <label for="description"
          >Does this Repository have a physical address?</label
        ><br />
        <label class="radio-inline">
          <input
            type="radio"
            name="address-exists"
            onclick="$('#address-fields').slideDown()"
          />Yes</label
        >
        <label class="radio-inline">
          <input
            type="radio"
            name="address-exists"
            onclick="$('#address-fields').slideUp()"
          />No</label
        >
      </div>
      ...
      <div class="form-group" id="website-question">
        <label for="description">Does this Repository have a Website?</label
        ><br />
        <label class="radio">
          <input
            type="radio"
            name="website-exists"
            onclick="$('#ZZZwebsite-question').hide();$('#website-fields').slideDown()"
          />Yes</label
        >
        <label class="radio">
          <input
            type="radio"
            name="website-exists"
            onclick="$('#ZZZwebsite-question').hide();$('#website-fields').slideUp()"
          />No</label
        >
      </div>
      ...
      <div class="form-group" id="language-question">
        <label for="description"
          >What languages are reference services offered in?
          <i
            class="fa fa-question-circle-o"
            aria-hidden="true"
            data-toggle="tooltip"
            data-placement="right"
            title="List the languages dominantly used in your institution"
          ></i> </label
        ><br />
      </div>
