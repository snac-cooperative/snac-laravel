  ...
  <div id="concept-table" classname="">
    ...
    <div v-show="entityType == 'person'">
      ...
      <div class="form-group">
        ...
        <i v-b-toggle.collapse-3 class="fa fa-question-circle-o" aria-hidden="true" data-toggle="sample-text" data-placement="right" title="Prefixes, suffixes, titles, or other identifying components (excluding dates)"></i>
        <b-collapse id="collapse-3">
          <b-card style="background-color: #f5f5f5">
            <p>Prefixes, suffixes, titles, or other identifying components (excluding dates) </p>
            ...
            <ul>
              <li>(Carpenter)</li>
              <li>Hercules (Chef) <i>[where "(Chef)" is the name addition]</i></li>
            </ul>
          </b-card>
        </b-collapse>
        <input type="text" value="" class="form-control" id="taskTitle"  name="name" placeholder="Prefixes, suffixes, titles, etc.">
      </div>

      <div class="form-group">
        <label for="title" >Date of Birth (if known)</label>
        <i v-b-toggle.collapse-4 class="fa fa-question-circle-o" aria-hidden="true" data-toggle="sample-text" data-placement="right" title="Write out date in the format of Month Day Year or MM-DD-YYYY."></i>
        ...
        <input type="text" value="" class="form-control" id=""  name="name" placeholder="Month Day Year or MM-DD-YYYY" style="width:50%">
      </div>

      <div class="form-group">
        <label for="title" >Date of Death (if known)</label>
        <i v-b-toggle.collapse-5 class="fa fa-question-circle-o" aria-hidden="true" data-toggle="sample-text" data-placement="right" title="Write out date in the format of Month Day Year or MM-DD-YYYY."></i>
      ...
      <div class="form-group">
        ...
        <label for="" class="radio-inline">
          <input type="radio" :value="true" name="additional-info" v-model=showAdditionalInfo> Yes
        </label>
        <label for="" class="radio-inline">
          <input type="radio" :value="false" name="additional-info" v-model=showAdditionalInfo> No
        </label>
      </div>
    ...
    <div v-show="entityType == 'family'">
      <div class="form-group">
        <label for="title" >Last Name</label>
        <i v-b-toggle.collapse-6 class="fa fa-question-circle-o" aria-hidden="true" data-toggle="sample-text" data-placement="right" title="Full name, unabbreviated" ></i>
      ...
      <div class="form-group">
        ...
        <i v-b-toggle.collapse-7 class="fa fa-question-circle-o" aria-hidden="true" data-toggle="sample-text" data-placement="right" title="Full name, unabbreviated" ></i>
        <b-collapse id="collapse-7">
          <b-card style="background-color: #f5f5f5">
            <p>Describe history of family, including names of prominent members and when and where the family lived.</p>
          </b-card>
        </b-collapse>
    ...
    <div v-show="entityType == 'corporateBody'">
      <div class="form-group">
        ...
        <i v-b-toggle.collapse-8 class="fa fa-question-circle-o" aria-hidden="true" data-toggle="sample-text" data-placement="right" title="Full name of organization, including name of parent organization, if one exists." ></i>
        <b-collapse id="collapse-8">
          <b-card style="background-color: #f5f5f5">
            <p>Full name of organization, including name of parent organization, if one exists; conference; event; etc.</p>
            <p>E.g.</p>
            <ul>
      ...
      <div class="form-group">
        ...
        <label for="" v-show="entityType != 'person'">History Note</label>
        <i v-b-toggle.collapse-9 class="fa fa-question-circle-o" aria-hidden="true" data-toggle="sample-text" data-placement="right" title="Full name of organization, including name of parent organization, if one exists." ></i>
        <b-collapse id="collapse-9">
          <b-card style="background-color: #f5f5f5">
            <p>San Diego Comic-Con International is a comic book convention and nonprofit multi-genre entertainment event held annually in San Diego, California since 1970.</p>
          </b-card>
        </b-collapse>
        <textarea name="" id="" type="text" class="form-control" ></textarea>
      </div>
      ...
      <table class="table table-hover mt-9">
        ...
        <tbody>
          <tr :key="cpf.id" v-for="(cpf) in relatedCPFs">
            ...
            <td><a :href="cpf.ark">{{ cpf.name }}</a></td>
            <td><button class="btn btn-danger" v-on:click="removeCPFRelation()">X</button></td>
    ...
    <!-- ok-title="Create Relationship" -->
      <form
        ...
        <div class="form-group">
          ...
          <div class="input-group mb-3">
            <select id="related-entity-search-type" ref="searchEntityType" class="form-control" style="width: 15%;">
            ...
            <div id="otherOptions" class="text-right" style="margin-top: 15px;">
              ...
              <select id="searchCount" ref="searchCount" name="count" style="width: 70px;">
        ...
        <b-button @click="relateCPF()" class="btn btn-info" title="Make Preferred">Relate CPF <i class="fa fa-floppy-o"></i></b-button>
      </form>
