...
<br>
    ...
    <form action="/repositories/create" method="post" style="max-width: 70%">
        ...
        <p> Example Resource Description: <a href="https://snaccooperative.org/vocab_administrator/resources/7754921"
                target="_blanck">Edgar A. Mearns correspondence</a></p>
        <hr>
        ...
        <div class="form-group">
            ...
            <b-collapse id="collapse-1">
                <b-card style="background-color: #f5f5f5">
                    ...
                    <p>The title should contain the name of the creator(s) or collector(s) of the collection and the kinds
                        of materials the collection contains (e.g., papers, photographs, correspondence, etc.)</p>
            ...
            <input type="text" value="" class="form-control required" id="taskTitle" name="name"
                placeholder="e.g. Edgar A. Mearns correspondence">
        </div>


        <div class="form-group">
            <label for="title">Date</label>
            <i v-b-toggle.collapse-2 class="fa fa-question-circle-o" aria-hidden="true" data-toggle="sample-text"
                data-placement="right" title=""></i>

            <b-collapse id="collapse-2">
                <b-card style="background-color: #f5f5f5">
                    <p>Earliest and latest dates of material in this resource. YYYY, YYYY-MM, YYYY-MM-DD formats. For a
                        range, separate with a slash.</p>
                    <p>e.g. 1883-1915</p>
        ...
        <div class="form-group" id="resource-link" style="display:none">
            ...
            <i v-b-toggle.collapse-link class="fa fa-question-circle-o" aria-hidden="true" data-toggle="sample-text"
                data-placement="right"
                title="The preferred permanent link to the finding aid or other descriptive resource."></i>
            ...
            <input type="url" value="" class="form-control" id="taskTitle" name="name"
        ...
        <div class="form-group">
            ...
            <i v-b-toggle.collapse-extent class="fa fa-question-circle-o" aria-hidden="true" data-toggle="sample-text"
                data-placement="right"
                title="The preferred permanent link to the finding aid or other descriptive resource."></i>

            <b-collapse id="collapse-extent">
                <b-card style="background-color: #f5f5f5">
                    <p>How big is the collection? What are the containers that hold your material? List the number of
                        containers or estimate how much space they take up.</p>
                    <p>e.g. 6 boxes</p>
        ...
        <div class="form-group" id="access-info" style="display:none">
            ...
            <i v-b-toggle.collapse-access class="fa fa-question-circle-o" aria-hidden="true" data-toggle="sample-text"
                data-placement="right"
                title="The preferred permanent link to the finding aid or other descriptive resource."></i>
            <b-collapse id="collapse-access">
                <b-card style="background-color: #f5f5f5">
                    <p>Information about access restrictions due to the nature of the information in the materials being
                        described.</p>
        ...
        <div class="form-group">
            ...
            <i v-b-toggle.collapse-code class="fa fa-question-circle-o" aria-hidden="true" data-toggle="sample-text"
                data-placement="right"
                title="The preferred permanent link to the finding aid or other descriptive resource."></i>

            <b-collapse id="collapse-code">
                <b-card style="background-color: #f5f5f5">
                    <p>A unique identifier for the unit being described. The identifier may consist of three subelements: a
                        local identifier, a code for the repository, and a code for the country.</p>
        ...
        <button type="button" class="btn btn-primary" onclick="$(this).hide();$('#relations').slideDown()">Save and
            Continue</button>
